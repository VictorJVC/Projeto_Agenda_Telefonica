...
. Preencha no arquivo config.php na pasta libs, o nome do seu servidor "localhost", "nome da base de dados", "usuario" e "senha" criados no Laragon em Mysql (editor Heidisql)
